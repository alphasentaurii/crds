...
@mark.diff
def test_diff_imap_diffs(default_shared_state, hst_data, capsys):
    """Compute diffs for two .imap's"""
    diffs = DiffScript(f"crds.diff {hst_data}/hst_acs_0001.imap {hst_data}/hst_acs_0002.imap")()
    out, _ = capsys.readouterr()
    default_shared_state.cleanup()
    assert diffs == 1
    print(out)
    expected = f"""(('{hst_data}/hst_acs_0001.imap', '{hst_data}/hst_acs_0002.imap'), ('test/data/hst/hst_acs_biasfile_0001.rmap', 'test/data/hst/hst_acs_biasfile_0002.rmap'), ('HRC', 'A', '1.0', '*', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A'), ('1992-01-02', '00:00:00'), 'replaced test/data/hst/hst_acs_biasfile_0001.fits with test/data/hst/hst_acs_biasfile_0002.fits')
...
@mark.diff
def test_diff_rmap_diffs(default_shared_state, hst_data, capsys):
    """Compute diffs for two .rmap's"""
    diffs = DiffScript(f"crds.diff {hst_data}/hst_acs_biasfile_0001.rmap {hst_data}/hst_acs_biasfile_0002.rmap --include-header-diffs")()
    out, _ = capsys.readouterr()
    default_shared_state.cleanup()
    assert diffs == 1
    print(out)
    expected = f"""(('{hst_data}/hst_acs_biasfile_0001.rmap', '{hst_data}/hst_acs_biasfile_0002.rmap'), ('HRC', 'A', '1.0', '*', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A'), ('1992-01-02', '00:00:00'), 'replaced test/data/hst/hst_acs_biasfile_0001.fits with test/data/hst/hst_acs_biasfile_0002.fits')
...
@mark.diff
def test_diff_fits_diff(default_shared_state, hst_data, capsys):
    """Compute diffs for two .fits's"""
    diffs = DiffScript(f"crds.diff {hst_data}/hst_acs_biasfile_0001.fits {hst_data}/hst_acs_biasfile_0002.fits")()
    out, _ = capsys.readouterr()
    default_shared_state.cleanup()
    assert diffs == 1
    print(out)
...
def dt_diff_rmap_primitive_diffs():
    ...
    ================================================================================
    (('{hst_data}/hst_acs_biasfile_0001.rmap', '{hst_data}/hst_acs_biasfile_0002.rmap'), ('HRC', 'A', '1.0', '*', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A'), ('1992-01-02', '00:00:00'), 'replaced data/hst_acs_biasfile_0001.fits with data/hst_acs_biasfile_0002.fits')
    <BLANKLINE>
     fitsdiff: ...
...
def dt_diff_file_reversions():
    ...
    (('{hst_data}/hst_0002.pmap', '{hst_data}/hst_0001.pmap'), ('{hst_data}/hst_acs_0002.imap', '{hst_data}/hst_acs_0001.imap'), ('{hst_data}/hst_acs_biasfile_0002.rmap', '{hst_data}/hst_acs_biasfile_0001.rmap'), ('HRC', 'A', '1.0', '*', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A'), ('1992-01-02', '00:00:00'), 'replaced data/hst_acs_biasfile_0002.fits with data/hst_acs_biasfile_0001.fits')
    ...
    (('{hst_data}/hst_0002.pmap', '{hst_data}/hst_0001.pmap'), ('{hst_data}/hst_acs_0002.imap', '{hst_data}/hst_acs_0001.imap'), ('biasfile',), 'replaced data/hst_acs_biasfile_0002.rmap with data/hst_acs_biasfile_0001.rmap')
    (('{hst_data}/hst_0002.pmap', '{hst_data}/hst_0001.pmap'), ('acs',), 'replaced data/hst_acs_0002.imap with data/hst_acs_0001.imap')
...
def dt_diff_recurse_added_deleted_na():
    ...
    (('.../mappings/hst/hst.pmap', '{hst_data}/hst.pmap'), ('hst_cos.imap', '{hst_data}/hst_cos.imap'), ('flatfile',), 'replaced hst_cos_flatfile.rmap with data/hst_cos_flatfile.rmap')
    ...
    (('.../mappings/hst/hst.pmap', '{hst_data}/hst.pmap'), ('hst_cos.imap', '{hst_data}/hst_cos.imap'), ('twozxtab',), 'added data/hst_cos_twozxtab_0262.rmap')
    ...
    (('.../mappings/hst/hst.pmap', '{hst_data}/hst.pmap'), ('cos',), 'replaced hst_cos.imap with data/hst_cos.imap')
    1
    >>> test_config.cleanup(old_state)
    """
